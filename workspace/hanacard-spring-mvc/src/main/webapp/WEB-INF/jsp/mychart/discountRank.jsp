					...
					success : function(data) { // data의 type : string --> json으로 바꾸자  ::  이용~ 
			           ...
			           for(i = 0; i < list[0].length; i++){
	 						...
	 						if(list[0][i].substring(0,1) == '#'){
	 				    	 ...
	 				    	 addListHtml += "</span>";
			            	 addListHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
			            	 addListHtml += "<span style =\"font-size: 30px; vertical-align: sub; color: #696969;\">" + list[0][i] + '&nbsp;&nbsp;&nbsp;￦' + numberWithCommas(parseInt(list[1][i])) + " 할인 혜택</span>";
			            	 addListHtml += "</div>";
			            	 addListHtml += "</li>";
			            	 addListHtml += "<br>";
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap">
		...
		<div class="container" align="center">
			...
			<br>
			<div>
				<h1 id = "category" class="m-0 font-weight-bold text-primary" style="display:inline; vertical-align: sub; border-bottom:  8px solid #57c4d0;">할인 혜택 TOP Chart</h1>
				<!-- <h1 class="m-0 font-weight-bold text-primary" style="display:inline; vertical-align: sub;"> TOP Chart</h1> -->
