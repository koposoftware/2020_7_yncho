					...
					success : function(data) { // data의 type : string --> json으로 바꾸자  ::  이용~ 
			           ...
			           for(i = 0; i < list[0].length; i++){
	 						...
	 						if(list[0][i].substring(0,1) == '#'){
				            	 ...
				            	 addListHtml += "<img src=\"/resources/images/" + list[0][i].substring(1, list[0][i].length)  + ".png\" style = \"width : 132px; height : 84px;\">";
			
			            	 } else{
			            		 
				            	 addListHtml += "<img src=\"/resources/images/" + list[0][i] + ".png\" style = \"width : 132px; height : 84px;\">";
			
			            	 }
	 						
	 				    	 addListHtml += "</span>";
			            	 addListHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
			            	 addListHtml += "<span style =\"font-size: 30px; vertical-align: sub; color: #696969;\">" + list[0][i] + '&nbsp;&nbsp;&nbsp;' + numberWithCommas(parseInt(list[1][i])) + " 마일 혜택</span>";
			            	 addListHtml += "</div>";
			            	 addListHtml += "</li>";
			            	 addListHtml += "<br>";
	...
	<div class="site-wrap">
		...
		<div class="custom-breadcrumns border-bottom">
			<div class="container">
				...
				<span class="current">마일리지순위</span>
			</div>
		</div>
		<%-- 페이지 소개 끝 --%>
		...
		<div class="container" align="center">
			...
			<br>
			<div>
				<h1 id = "category" class="m-0 font-weight-bold text-primary" style="display:inline; vertical-align: sub; border-bottom:  8px solid #57c4d0;">마일리지 혜택 TOP Chart</h1>
				<!-- <h1 class="m-0 font-weight-bold text-primary" style="display:inline; vertical-align: sub;"> CHART</h1> -->
