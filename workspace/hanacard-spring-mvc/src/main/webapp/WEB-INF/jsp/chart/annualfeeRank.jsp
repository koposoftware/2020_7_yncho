						...
						<div id="topImg" align="center" style ="width : 170px; vertical-align: middle; display: inline-block; float : left;">
							<c:choose>
								<c:when test="${ fn:substring(annualfeeSortList[0].cardName, 0, 1) == '#'  }">
									<br>
									<img src="/resources/images/${ fn:substring(annualfeeSortList[0].cardName, 1, fn:length(annualfeeSortList[0].cardName)) }.png" style = "width : 198px; height : 126px;">
								</c:when>
								<c:otherwise>
									<br>
									<img src="/resources/images/${ annualfeeSortList[0].cardName }.png" style = "width : 198px; height : 126px;">
								</c:otherwise>
							</c:choose>
						</div>
						<br>
