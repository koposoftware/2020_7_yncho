						...
						<div id="topImg" align="center" style ="width : 170px; vertical-align: middle; display: inline-block; float : left;">
							<c:choose>
								<c:when test="${ fn:substring(benefitSortList[0].cardName, 0, 1) == '#'  }">
									<br>
									<img src="/resources/images/${ fn:substring(benefitSortList[0].cardName, 1, fn:length(benefitSortList[0].cardName)) }.png" style = "width : 198px; height : 126px;">
								</c:when>
								<c:otherwise>
									<br>
									<img src="/resources/images/${ benefitSortList[0].cardName }.png" style = "width : 198px; height : 126px;">
								</c:otherwise>
							</c:choose>
						</div>
						<br>
					...
					<c:forEach items = "${benefitSortList}" var ="top" varStatus="loop">
						<li>
							...
							<!-- <div style = "background-color: #E8F5FF;"> -->
								...
								<%-- <img src="/resources/images/${ card.cardProductName }.png" style = "width : 132px; height : 84px;"> --%>
