...
<script>
	...
	function getTopThree() {
		...
		$.ajax({
			...
			url : '${ pageContext.request.contextPath }/chart/typerank/' + category + '/' + year + '/' + month,
			type : 'get', 
			//async : false,
			...
			<div class="container">
				<div class="row align-items-end justify-content-center text-center">
					<div class="col-lg-7">
						...
						<p>카드 타입별로 손님들이 선호하는 카드를 살펴보세요.</p>
		...
		<div class="container" align="center">
				...
				<div style = "height : 350px; vertical-align: middle; background-image: url('/hanacard-spring-mvc/resources/images/cardback2.jpg');">
					<div>
						...
						<div id="topImg" align="center" style ="width : 170px; vertical-align: middle; display: inline-block; float : left;">
							<c:choose>
								<c:when test="${ fn:substring(typeSortList[0].cardName, 0, 1) == '#'  }">
									<br>
									<img src="/hanacard-spring-mvc/resources/images/${ fn:substring(typeSortList[0].cardName, 1, fn:length(typeSortList[0].cardName)) }.png" style = "width : 198px; height : 126px;">
								</c:when>
								<c:otherwise>
									<br>
									<img src="/hanacard-spring-mvc/resources/images/${ typeSortList[0].cardName }.png" style = "width : 198px; height : 126px;">
								</c:otherwise>
							</c:choose>
						</div>
						<br>
						<br>
						<div id="topName" align="left" style = "width : 360px; font-size: 30px; color: #696969; font-family: HanaM; display: inline-block; float : left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${typeSortList[0].cardName}</div>
					</div>
					...
					<div class="modal-content">
						...
						<form name="mform">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">카드타입별 순위</h5>
			...
			<div align="left">
				...
				<ul id = "ulList" type = "none"> 
					...
					<c:forEach items = "${typeSortList}" var ="top" varStatus="loop">
						<li>
