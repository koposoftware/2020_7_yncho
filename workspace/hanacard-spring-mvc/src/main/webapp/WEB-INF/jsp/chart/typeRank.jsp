						...
						<div id="topImg" align="center" style ="width : 170px; vertical-align: middle; display: inline-block; float : left;">
							<c:choose>
								<c:when test="${ fn:substring(typeSortList[0].cardName, 0, 1) == '#'  }">
									<br>
									<img src="/resources/images/${ fn:substring(typeSortList[0].cardName, 1, fn:length(typeSortList[0].cardName)) }.png" style = "width : 198px; height : 126px;">
								</c:when>
								<c:otherwise>
									<br>
									<img src="/resources/images/${ typeSortList[0].cardName }.png" style = "width : 198px; height : 126px;">
								</c:otherwise>
							</c:choose>
						</div>
						<br>
