...
대부분의 카드사들은 획일적인 카드 추천 프로세스를 가지며 손님이 정보 탐색에 많은 시간을 들이는 구조다. 이러한 점에 착안하여 소비패턴 기반 자동화 카드 추천 서비스를 개발했다. 이를 통해 손님들의 정보 탐색 시간을 줄일 수 있고, 흩어져 있는 소비를 모아 수수료 이익 향상을 기대할 수 있다.
<br>
<br>
